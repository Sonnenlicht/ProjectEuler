...
#print(pent_dict[(5, 4676)])
#print(tri_dict[(3, 7626)])
#print(hex_dict[(6, 7626)])
#print(all_dict)
#print((tri_dict))
...
#def super_cycle(tuple_key, list_val, key_list, link_list):
#    for item in list_val:
#        cycle(item, all_dict[item], key_list, link_list) 
...
def cycle(tuple_key, list_val):
    ...
    for item in list_val:
        #print('ITEM')
        #print(cycle_list, item, key_list)
        if len(cycle_list) < 6:
            if item[0] not in key_list:
                #print('CYCLE LIST BEGIN')
                #print(cycle_list)
                #print('CYCLE LIST END')
            ...
            #else:
            #    if item[0] == key_list[0] and (item[1] % 100) == (tuple_key[1] // 100):
            #        key_list.append(item[0])
            #        link_list.append(item)
            #        return cycle(item, all_dict[item], key_list, link_list)
    #print('RETURN')
    if len(cycle_list) > 1:
        del key_list[-1]
        del cycle_list[-1]
...
#for tuple_key, list_val in all_dict.items():
#    link_list = [tuple_key]
#    cycle(tuple_key, list_val, link_list)

#sample_tuple = (8, 1281)
#cycle(sample_tuple, all_dict[sample_tuple]) 
#print(all_dict[sample_tuple])
#print(cycle_list, key_list)

#for item in all_dict[sample_tuple]:
#    key_list = [sample_tuple[0], item[0]]
#    link_list = [sample_tuple, item]
...
#for tuple_item in tri_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)          
        
#for tuple_item in sqr_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)            
    
#for tuple_item in pent_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)            
    
#for tuple_item in hex_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)            
    
#for tuple_item in hept_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)            
    
#for tuple_item in oct_list:
#    link_list = [(tuple_item)]
#    key_list = [tuple_item[0]]
#    cycle(tuple_item, all_dict[tuple_item], key_list, link_list)            
    
#print(all_dict[(5, 4030)])
#print(all_dict[(4, 4096)])
#print(all_dict[(3, 4095)])
#print(all_dict[(3, 2628)])
#print(all_dict[(7, 2673)])
#print(all_dict[(5, 2176)])
